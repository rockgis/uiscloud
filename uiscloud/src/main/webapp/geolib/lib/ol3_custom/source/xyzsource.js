...
goog.inherits(tbies.XYZ, ol.source.TileImage);
 ...
 * @api stable
 */
tbies.XYZ.prototype.setUrl = function(url) {
 ...
 */
tbies.XYZ.prototype.setUrls = function(urls) {
