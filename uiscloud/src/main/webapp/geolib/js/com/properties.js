...
// 지도 서비스 주소
// 운영서버
var gisUrl = "http://uiscloud.iptime.org:18081/uiscloud/wms";
...
var blankLayer = "uiscloud:blank_layer";
...
proj4.defs('EPSG:900913', "+title=GoogleMercator +proj=merc +a=6378137 +b=6378137 +lat_ts=0.0 +lon_0=0.0 +x_0=0.0 +y_0=0 +k=1.0 +units=m +nadgrids=@null +no_defs");
proj4.defs('http://www.opengis.net/gml/srs/epsg.xml#900913', "+title=GoogleMercator +proj=merc +a=6378137 +b=6378137 +lat_ts=0.0 +lon_0=0.0 +x_0=0.0 +y_0=0 +k=1.0 +units=m +nadgrids=@null +no_defs");
...
var moveMapHistory = function(type){
	if(type == "prev") index--;
	else index++;
...
// vworld
var VWorldProj = new ol.proj.Projection({
	code : "EPSG:900913",
...
// naver
var NaverProj = new ol.proj.Projection({
	code : "EPSG:5179",
