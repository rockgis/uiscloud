...
var mapInfoBookmark = {
	...
	***********************************************************************/
	initheadOfficeComboBoxes: function() {
		...
		$.get("/titan/bookmark/regionList", function(response) {
...
//						var imageFile = '/titan/images/geoserver/' + row.symbolizer + '.png';
...
//		alert(message);		
		...
		var targetUrl = "/titan/mapInfo/searchBookmark";
...
//	    	    		
//	    	    		$("#" + gridId).datagrid("getPanel").panel('refresh', '/titan/mapInfo/search?' + queryString);
	            	}
	    	    });
	        }
	    });		
	...
	onClickRow: function(rowIndex, rowData) {
		...
		$.ajax({
			type: "POST",
			url: "/titan/mapInfo/searchBookmarkExcel",
			data: {
