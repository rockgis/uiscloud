...
BiesModifyFeature = OpenLayers.Class(OpenLayers.Control.ModifyFeature, {
	...
	dragStyle : {
		graphicOpacity : 1,
		externalGraphic : "/bies/images/userlayer/move.png",
		graphicWidth : 16,
		graphicHeight :  16
	},
	...
	resizeStyle : {
		graphicOpacity : 1,
		externalGraphic : "/bies/images/userlayer/resize.png",
		graphicWidth : 16,
		graphicHeight :  16
    },
	...
	rotateStyle : {
		graphicOpacity : 1,
		externalGraphic : "/bies/images/userlayer/rotate.png",
		graphicWidth : 16,
		graphicHeight :  16
    },
...
UserContent = OpenLayers.Class({
	...
	attributesList : {
		...
		'marker' : {
			featureType : "marker",
			graphicOpacity : 1,
			externalGraphic : "http://211.58.18.254:8180"+"/www/symbol/symbol.png",
			graphicWidth : 32,
			graphicHeight :  32
		},
