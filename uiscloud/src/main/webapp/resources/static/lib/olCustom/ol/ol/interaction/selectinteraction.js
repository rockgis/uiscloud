/*
 * provide를 제거해야 Custom으로 사용 가능
 * provide : 객체의 중복 선언을 체크한다.
 *
...
ol.interaction.Select = function(opt_options) {
  ...
  //ol3 커스터마이징
  this.oldStyle = ol.interaction.Select.getDefaultStyleFunction();
};
...
//ol3 커스터마이징
  ...
  if(oldStyle){
	  ...
	  var width = oldStyle.getImage().radius_;
	  var lWidth = 5;
  ...
  feature.set("targetTableNm",$('#select_editTargetLayer').val());
  if(feature.get("transactionMode") != "insert"){
	  feature.set("transactionMode","update");
  }
