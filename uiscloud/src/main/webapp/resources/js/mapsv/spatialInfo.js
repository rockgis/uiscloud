					...
					for(var i in res.data) {
						...
						if(tableObj.datas.length > 0) {
							...
							if(i.toUpperCase() == "GNET_RING_MAP") {
								datagrid.showResult(title, i, datas, ring.gridColumns, false, function(rowIndex, rowData, tableName) {
...
//		debugger;
		$.get(
			"/bies/mapsv/selectSpatialDetailInfo",
