...
BiesModifyFeature = OpenLayers.Class(OpenLayers.Control.ModifyFeature, {
	...
	dragStyle : {
		graphicOpacity : 1,
		externalGraphic : "/bies/images/mapsv/usercontent/move.png",
		graphicWidth : 16,
		graphicHeight :  16
	},
	...
	resizeStyle : {
		graphicOpacity : 1,
		externalGraphic : "/bies/images/mapsv/usercontent/resize.png",
		graphicWidth : 16,
		graphicHeight :  16
    },
	...
	rotateStyle : {
		graphicOpacity : 1,
		externalGraphic : "/bies/images/mapsv/usercontent/rotate.png",
		graphicWidth : 16,
		graphicHeight :  16
    },
...
UserContent = OpenLayers.Class({
	...
	attributesList : {
		...
		'marker' : {
			featureType : "marker",
			graphicOpacity : 1,
			externalGraphic : "/bies/images/mapsv/usercontent/symbol.png",
			graphicWidth : 32,
			graphicHeight :  32
		},
		...
		'image' : {
			...
			externalGraphic : "/bies/images/etc/blank.gif",
			graphicWidth : 32,
			graphicHeight :  32,
			graphicRotate : 0
		}
	...
	getImage : function(user) {
		return {
			externalGraphicBase : "/bies/fileDownload?requestedFile=" + encodeURIComponent(this.image.externalGraphic) + "&userId=" + user,
			externalGraphic : "/bies/fileDownload?requestedFile=" + encodeURIComponent(this.image.externalGraphic) + "&userId=" + user,
