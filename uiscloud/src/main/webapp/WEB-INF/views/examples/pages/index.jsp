...
<head>
    ...
    <!-- Timeline CSS -->
    <link href="/resources/examples/dist/css/timeline.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="/resources/examples/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="/resources/examples/bower_components/morrisjs/morris.css" rel="stylesheet">
...
<body>
    ...
    <script src="/resources/examples/bower_components/raphael/raphael-min.js"></script>
    <script src="/resources/examples/bower_components/morrisjs/morris.min.js"></script>
    <script src="/resources/examples/js/morris-data.js"></script>
