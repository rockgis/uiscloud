...
<!--
	...
	function fn_egov_selectList() {
		document.getElementById("detailForm").action = "<c:url value='/titan/bbs/Bbs'/>";
	...
	function fn_egov_save() {
		...
		frm.action = '<c:url value="/titan/bbs/addBbs" />';
		frm.submit();
	}
// -->
</script>
	...
	<form:form commandName="bbsVO" name="detailForm" id="detailForm" class="form-horizontal" enctype="multipart/form-data">
		...
		<div class="row-fluid">
			<div class="span12 text-right">
				<a href="#" onclick="fn_egov_save();"><img src="/titan/images/bbs/btn_enter.png" alt="등록" /></a>
				<a href="#" onclick="fn_egov_selectList('<c:out value='${ssbbsType}'/>');"><img src="/titan/images/bbs/btn_list.png" alt="목록" /></a>
			</div>
		</div>
		<!-- 검색조건 유지 -->
