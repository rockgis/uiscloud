...
<div class="row-fluid">
	...
	<div class="text-right" style="padding-top:10px;">
		...
		<a href="#" onclick="fnSearchNotice();"><img src="/titan/images/bbs/btn_search.png" alt="검색" /></a>
		<a href="#" onclick="fnResetNotice();"><img src="/titan/images/bbs/btn_reset.png" alt="초기화" /></a>
	</div>
</div>
<div class="row-fluid" style="margin-top: 30px;">
	...
	<div class="row-fluid">
		...
		<div class="span1 text-right">
			<sec:authorize access="hasRole('ROLE_ADMIN')"><a href="#" onclick="fn_egov_addNotice();"><img src="/titan/images/bbs/btn_enter.png" alt="등록" /></a></sec:authorize>
		</div>
	</div>
</div>
</form:form>
