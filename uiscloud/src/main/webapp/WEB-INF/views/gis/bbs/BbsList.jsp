...
<div class="row-fluid">
	...
	<div class="text-right" style="padding-top:10px;">
		...
		<a href="#" onclick="fnSearch();"><img src="/gis/images/bbs/btn_search.png" alt="검색" /></a>
		<a href="#" onclick="fnReset();"><img src="/gis/images/bbs/btn_reset.png" alt="초기화" /></a>
	</div>
</div>
<div class="row-fluid" style="margin-top: 30px;">
	...
	<div class="row-fluid">
		...
		<div class="span1 text-right">
			<a href="#" onclick="fn_egov_addView();"><img src="/gis/images/bbs/btn_enter.png" alt="등록" /></a>
		</div>
	</div>
</div>
</form:form>
