...
<body>
	...
	<div id="div_layout" class="easyui-layout" data-options="fit: true">
		...
		<div id="div_north" data-options="region:'north'">
			...
			<!--  ul id="ul_menu">
				...
				<li><a href="#" id="a_menu_pgRouting"><img src="/gis/images/main_menu/single_route_n.png" class="toggle" alt="단일경로 검색" /></a></li>
				<li><a href="#" id="a_menu_kRouting"><img src="/gis/images/main_menu/multi_route_n.png" class="toggle" alt="다중경로 검색" /></a></li>
			...
			<div id="sse50">
			  <div id="sses50">
			    <ul>
			      ...
			      <li><a href="#" id="a_menu_pgRouting">단일 Network 검색</a></li>
			      <li><a href="#" id="a_menu_pgRouting">다중 Network 검색</a></li>
			      <li><a href="#" id="a_menu_pgRouting">최단 Network 검색</a></li>
	...
	<!-- 레이어정보 -->
	<script type="text/javascript" src="/gis/js/mapInfo/layerTree_u.js"></script>
	<!-- 시설물 검색 -->
	...
	<script type="text/javascript">
		...
		//gisUrl = "http://uiscloud.iptime.org:18180/uiscloud/wms";
		//blankLayer = "uiscloud:blank_layer";
	...
	<script type="text/javascript" src="/gis/js/com/menu.js"></script>
