...
$(document).ready(function() {	
	...
	$('#dg').datagrid({
		...
		columns: [[
			...
			, {field:'상위국unq_mgno',title:'상위국unq_mgno',width:120,align:'left', sortable: true}
			, {field:'하위국PNU',title:'하위국PNU',width:80,align:'left', sortable: true}
			, {field:'하위국 주소',title:'하위국 주소',width:200,align:'left', sortable: true}
			, {field:'하위국대번지',title:'하위국대번지',width:100,align:'right', sortable: true}
			, {field:'하위국소번지',title:'하위국소번지',width:100,align:'right', sortable: true}
