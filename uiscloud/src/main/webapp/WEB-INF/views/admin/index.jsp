  ...
  <div class="toolbar">
    ...
    <span style="float:right">
      <select onchange="changeTheme(this.value)">
        <option value="jennifer">UISCLOUD</option>
      ...
      <div class="panel dashed">
        <div class="body">
          ...
          <div class="row view info">
            <div class="col col-7">
              <div class="title">
                <strong>1,452,587</strong> people visited this site
              </div>
              <div class="box">
          ...
          <div class="view">
            ...
            <div class="panel">
              ...
              <table class="table simple hover">
                ...
                <tr>
                  <td>
                    <i class="icon-stop" style="font-size:8.5px;color:#fff860;"></i>
                    Lion KC
                  </td>
                  <td>Robin Van Persie</td>
                  <td>$245.00</td>
                ...
                <tr>
                  <td>
                    <i class="icon-stop" style="font-size:8.5px;color:#fb32ff;"></i>
                    Lion KC
                  </td>
                  <td>Robin Van Persie</td>
                  <td>$245.00</td>
                ...
                <tr>
                  <td>
                    <i class="icon-stop" style="font-size:8.5px;color:#68ff41;"></i>
                    Lion KC
                  </td>
                  <td>Robin Van Persie</td>
                  <td>$245.00</td>
                ...
                <tr>
                  <td>
                    <i class="icon-stop" style="font-size:8.5px;color:#5d9cff;"></i>
                    Lion KC
                  </td>
                  <td>Robin Van Persie</td>
                  <td>$245.00</td>
