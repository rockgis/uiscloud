...
var pgRoutingNew = {
	// 시설물 종류
	cableType: $("#frmPgRoutingNew :radio[name='cableType']"),
		
	// 그리기 버튼
	drawLineButton: $("#frmPgRoutingNew .drawLine"),
	
	// 지우기 버튼
	removeLineButton: $("#frmPgRoutingNew .removeLine"),
	
	// 엑셀 다운로드 
	downloadExcelButton: $("#frmPgRoutingNew .downloadExcel"),
	...
	***********************************************************************/ 
	initGis: function() {
		...
		// 레이어 추가 
		that.layer = new BiesVector("pgRoutingNew", {
		...
		that.layer.events.on({
            ...
            sketchcomplete: function(evt) {
				...
				$(popup.div).css("background", "transparent");
	...
	***********************************************************************/
	drawLine: function() {
		...
		gfnActiveControl(["pan" , "pgRoutingNew"]);
	}, 
	...
	***********************************************************************/
	downloadExcel: function() {
		...
		for(var i=0, len=popups.length; i < len; i++) {
			if(popups[i].type == "pgRoutingNew" && popups[i].attributes) {
				var isPush = false;
