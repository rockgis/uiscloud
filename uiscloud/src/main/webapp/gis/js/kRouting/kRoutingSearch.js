...
var kRoutingSearch = {
	...
	// 투자비산출기준
	byICost: $("#frmKRouting :radio[name='byICost']"),
	
	// 혼합구분 
	sysClf: $("#frmKRouting :radio[name='sysClf']"),
	
	// 망구분
	// 망구분 - SKT기간망링
	sktBbring: $("#frmKRouting :checkbox[name='skt_bbring']"),
	
	// 망구분 - SKT중심국링
	sktCtring: $("#frmKRouting :checkbox[name='skt_ctring']"),
	
	// 망구분 - SKT기지국링
	sktBsring: $("#frmKRouting :checkbox[name='skt_bsring']"),
	
	// 망구분 - SKT중계기P2P
	sktRfptp: $("#frmKRouting :checkbox[name='skt_rfptp']"),
	
	// 망구분 - SKT기타
	sktEtc: $("#frmKRouting :checkbox[name='skt_etc']"),
	
	// 망구분 - SKB링
	skbRing: $("#frmKRouting :checkbox[name='skb_ring']"),
	
	// 한전배전
	gisCode: $("#frmKRouting :checkbox[name='gisCode']"),
	
	// cost 산출조건
	byCost: $("#frmKRouting :radio[name='byCost']"),

	// BBOX 영역설정
	bufferArea: $("#frmKRouting :radio[name='bufferArea']"),	
	bufferAreaTxt: $("#frmKRouting .bufferAreaTxt"),
	
	// 접속코어수
	conCoreCount: $("#frmKRouting .conCoreCount"),
	
	// 신설포설단가
	newPpPrice: $("#frmKRouting .newPpPrice"),

	// 용량조건(% 이하)
	capacity: $("#frmKRouting .capacity"),
	
	// 잔여코어용량(개수 이상)
	remainCapacity: $("#frmKRouting .remainCapacity"),
	
	// 접속점조건(개수 이상)
	// connectingPointCount: $("#frmKRouting .connectingPointCount"),
	
	// 매설위치 구분
	ungrLoc: $("#frmKRouting :checkbox[name='ungrLoc']"),
	
	// 코어용량(이상)
	coreCount: $("#frmKRouting .coreCount"),
	...
	// BBOX 버튼
	bboxPointButton: $("#frmKRouting .bboxPoint"),
	// 분석 버튼
	analyzeButton: $("#frmKRouting .analyze"),
	// 엑셀업로드 버튼
	routingExcelButton: $("#frmKRouting .routingExcel"),
	// 경유지 점 버튼
	// stopOverPointsButton: $("#frmKRouting .stopOverPoints"),
	// 불경유지 점 버튼
	nonStopOverPointsButton: $("#frmKRouting .nonStopOverPoints"),
	// 경유지 선 버튼
	// stopOverLinesButton: $("#frmKRouting .stopOverLines"),
	// 불경유지 선 버튼
	nonStopOverLinesButton: $("#frmKRouting .nonStopOverLines"),
	// 불경유지 영역 버튼
	nonStopOverAreaButton: $("#frmKRouting .nonStopOverArea"),
	//다각선 지우기
	bboxClearButton : $("#frmKRouting .bboxClear"),
	// 지우기 버튼
	initPointButton: $("#frmKRouting .initPoint"),
	// 초기화 버튼
	initPointAllButton: $("#frmKRouting .initPointAll"),
...
//		});
	...
	***********************************************************************/
	...
	리턴값 :
	***********************************************************************/
	routingExcel: function() {
		var that = this;
		
		window.open("/gis/routingExcel/List", "라우팅 엑셀", "top=50px, left=50px, width=1200px, height=700px, menubar=no, resizable=no, status=no, titlebar=no, toolbar=no, scrollbars=yes").focus();
	},
...
//		}
	...
	selectStart: function() {
		...
		if( that.source != "") {
			$.messager.alert("알림", "시작점이 이미 선택되어 있습니다.");
			return;
		}
//		this.source = "";
//		this.targets = [];
...
//	    ]);
	...
	gridColumns: [
      ...
      // 	, {field:"sourceAddress", title:"시작점 주소", width:120, halign:"right", align:"center", sortable: true, checkbox:false}
     //  	, {field:"targetAddress", title:"종료점 주소", width:120, halign:"right", align:"center", sortable: true, checkbox:false}
     //  	, {field:"targetCaMgnoUnqMgno", title:"종료점 시설물고유관리번호", width:120, halign:"right", align:"center", sortable: true, checkbox:false}
    ],
