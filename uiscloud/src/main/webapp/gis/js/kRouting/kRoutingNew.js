...
var kRoutingNew = {
	// 시설물 종류
	cableType: $("#frmKRoutingNew :radio[name='cableType']"),
	
	// 그리기 버튼
	drawLineButton: $("#frmKRoutingNew .drawLine"),
	
	// 지우기 버튼
	removeLineButton: $("#frmKRoutingNew .removeLine"),
	
	// 엑셀 다운로드 
	downloadExcelButton: $("#frmKRoutingNew .downloadExcel"),
	...
	***********************************************************************/ 
	initGis: function() {
		...
		// 레이어 추가 
		that.layer = new BiesVector("kRoutingNew", {
	...
	***********************************************************************/
	drawLine: function() {
		...
		gfnActiveControl(["pan" , "kRoutingNew"]);
	}, 
	...
	***********************************************************************/
	downloadExcel: function() {
		...
		for(var i=0, len=popups.length; i < len; i++) {
			if(popups[i].type == "kRoutingNew" && popups[i].attributes) {
				var isPush = false;
		...
		kRoutingSearch.downloadExcel(newLines);
	}
};
