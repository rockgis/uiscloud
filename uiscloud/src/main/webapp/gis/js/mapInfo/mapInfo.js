...
var mapInfo = {
	...
	***********************************************************************/
	bindEvents: function () {
		...
		$("#a_layer_DaumHybrid").click(that.toggleDaumHybrid);
	
		// DaumSatellite 레이어 on/off
		$("#a_layer_DaumSatellite").click(that.toggleDaumSatellite);	
	...
	***********************************************************************/
	toggleBaseLayer: function () {
		...
		if($(that).hasClass("layer_on")) {
			gfnGetLayer("DaumStreetMap").setVisibility(false);
			...
			gfnGetLayer("DaumStreetMap").setVisibility(true);
	...
	/**********************************************************************
	설명 : DaumHybridMap 레이어 ON/OFF
	파라메터 :
	리턴값 :
	***********************************************************************/
	toggleDaumHybrid: function () {
		var that = this;
		
		if($(that).hasClass("layer_on")) {
			gfnGetLayer("DaumHybridMap").setVisibility(false);
			//gfnMergeNewParams("biesBaseLayer", gfnGetBaseLayerList(false));
			$(that).removeClass("layer_on");
			$(that).find("img").attr("src", $(that).find("img").attr("src").replace("_a.", "_n."));			
		}
		else {
			gfnGetLayer("DaumHybridMap").setVisibility(true);
			$(that).addClass("layer_on");
			$(that).find("img").attr("src", $(that).find("img").attr("src").replace("_n.", "_a."));
		}
	},
	...
	/**********************************************************************
	설명 : DaumSatelliteMap 레이어 ON/OFF
	파라메터 :
	리턴값 :
	***********************************************************************/
	toggleDaumSatellite: function () {
		var that = this;
		
		if($(that).hasClass("layer_on")) {
			gfnGetLayer("DaumSatelliteMap").setVisibility(false);
			//("biesBaseLayer", gfnGetBaseLayerList(false));
			$(that).removeClass("layer_on");
			$(that).find("img").attr("src", $(that).find("img").attr("src").replace("_a.", "_n."));			
		}
		else {
			gfnGetLayer("DaumSatelliteMap").setVisibility(true);
			$(that).addClass("layer_on");
			$(that).find("img").attr("src", $(that).find("img").attr("src").replace("_n.", "_a."));
		}
	},
