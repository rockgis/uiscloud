...
function gfnInitMainMap() {
	...
	gfnAppendBaseLayer(map);															// 지도 초기화 - /gis/js/mapsv/map.js
	gfnAppendWmsLayer(map, "biesLayer"); //  레이어 - /gis/js/mapsv/map.js 
	spatialInfo.init(map);	// 정보보기 초기화 - /gis/js/mapsv/spatialInfo.js		
