goog.provide('ol.tilegrid.Naver');

goog.require('ol.tilegrid.XYZ');

ol.tilegrid.Naver = function(options) {
	goog.base(this, {
...
goog.inherits(ol.tilegrid.Naver, ol.tilegrid.XYZ);

ol.tilegrid.Naver.prototype.createTileCoordTransform = function(opt_options) {
